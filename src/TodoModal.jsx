          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200 rounded-t">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                type="button"
                onClick={onClose}
                className="hidden sm:inline-flex text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 inline-flex justify-center items-center transition-all"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
